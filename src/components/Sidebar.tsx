...
const Icons: Record<string, React.ReactNode> = {
  ...
  skills: <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path></svg>,
};
  ...
  ['flasher', '系统烧录'],
      ...
      <div className="section-label">AI Skills</div>
      <div className="sidebar-tools">
        <button className={`tool-btn ${activeTab === 'skills' ? 'active' : ''}`} onClick={() => setActiveTab('skills')}>
          <span className="tool-icon" style={{display:"flex",alignItems:"center",justifyContent:"center"}}>{Icons.skills}</span> <span style={{marginLeft:"8px"}}>技能管理</span>
        </button>
      </div>
