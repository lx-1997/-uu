...
export const EN: Record<string, string> = {
  ...
  'settings.policy.desc': 'Host/device access limits, memory, and network; tools run without per-step prompts when allowed.',
  'settings.policy.approvalTitle': 'Tool execution',
  'settings.policy.approvalNote':
    'Tools run directly within allowed scope with no step-by-step confirmation; host/device access still follows the safety rules and local audit below.',
  'settings.policy.permissionPreamble':
    'These options protect your workspace and device access. They stay on by default; rules and audit data stay on this machine and are not sent out automatically.',
  ...
  'settings.policy.permissionTitle': 'Safety and access limits',
  'settings.policy.workspaceBoundary': 'Limit which local folders the assistant can access',
  'settings.policy.devicePathAllow': 'SSH path allowlist on the device',
  'settings.policy.hostGuard': 'Protect the Studio install directory',
  'settings.policy.cmdGuard': 'Block high-risk commands',
  'settings.policy.auditLog': 'Local security audit',
  'settings.policy.permissionHint':
    'Actions outside the allowed scope are blocked. Audit entries are stored locally only—protect your device and account.',
